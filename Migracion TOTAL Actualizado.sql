...
BEGIN TRY
    ...
    WHEN MATCHED THEN
      UPDATE SET tgt.Nombre = src.Nombre, tgt.FechaIngreso = src.FechaIngreso, tgt.Activo = src.Activo, tgt.EstadoId = src.EstadoId, tgt.SeccionId = src.SeccionId,
                 ...
                 tgt.FechaNacimiento = src.FechaNacimiento, tgt.Domicilio = src.Domicilio, tgt.Email = src.Email, tgt.EscalafonId = src.EscalafonId,
                 tgt.FuncionId = src.FuncionId, tgt.UpdatedAt = SYSUTCDATETIME()
    WHEN NOT MATCHED BY TARGET THEN
      INSERT (CI,Nombre,FechaIngreso,Activo,CreatedAt,UpdatedAt,EstadoId,SeccionId,PuestoTrabajoId,TurnoId,SemanaId,HorarioId,GeneroId,NivelEstudioId,EstadoCivilId,CargoId,FechaNacimiento,Domicilio,Email,EscalafonId,FuncionId,TipoFuncionarioId)
      VALUES (src.CI,src.Nombre,src.FechaIngreso,src.Activo,src.CreatedAt,src.UpdatedAt,src.EstadoId,src.SeccionId,src.PuestoTrabajoId,src.TurnoId,src.SemanaId,src.HorarioId,src.GeneroId,src.NivelEstudioId,src.EstadoCivilId,src.CargoId,src.FechaNacimiento,src.Domicilio,src.Email,src.EscalafonId,src.FuncionId,1);
    ...
    USING (
      ...
      ON tgt.Id = src.Id
    WHEN NOT MATCHED THEN
      INSERT (Id,FuncionarioId,TipoEstadoTransitorioId,CreatedAt,UpdatedAt)
      VALUES(src.Id,src.FuncionarioId,src.TipoEstadoTransitorioId,src.FechaDesde,src.FechaHasta);
