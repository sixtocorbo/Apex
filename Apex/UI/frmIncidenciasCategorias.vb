...
Partial Class frmIncidenciasCategorias
    ...
    Private Sub ConfigurarGrilla()
        ...
        .HeaderText = "Nombre de la Categoría", ' <-- Título más descriptivo
        .AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
    })

        AplicarEstiloGrilla(dgvCategorias) ' <-- Tu llamada existente, que ahora usará el nuevo estilo
    End Sub
    ...
    Private Sub AplicarEstiloGrilla(dgv As DataGridView)
        ...
        dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(242, 245, 247) ' Efecto Cebra

        ' Doble buffer por reflexión (se mantiene tu lógica original)
        Try
