...
Partial Public Class frmFiltroAvanzado2

#Region "Modelos y Clases de Ayuda"

    Friend Enum OperadorComparacion2
        Igual
        Contiene
        EmpiezaCon
        TerminaCon
    ...
    Friend Class ReglaFiltro2
        Public Property Columna As String = String.Empty
        Public Property Operador As OperadorComparacion2
        Public Property Valor1 As String = String.Empty
        Public Property Valor2 As String = String.Empty


        Public Overrides Function ToString() As String
            Dim op = [Enum].GetName(GetType(OperadorComparacion2), Operador)
            Return If(Operador = OperadorComparacion2.Entre,
        ...
        Public Function ToRowFilter() As String
            ...
            Select Case Operador
                Case OperadorComparacion2.Igual
                ...
                Case OperadorComparacion2.EnLista
    ...
    Friend Class GestorFiltros2
        Private ReadOnly _reglas As New BindingList(Of ReglaFiltro2)()

        Public ReadOnly Property Reglas As BindingList(Of ReglaFiltro2)
            Get
                Return _reglas
            End Get
        End Property
        ...
        Public Sub Agregar(r As ReglaFiltro2)
            _reglas.Add(r)
        End Sub

        Public Sub Quitar(r As ReglaFiltro2)
            _reglas.Remove(r)
        End Sub
...
#Region "Campos del Formulario"
    ...
    Private ReadOnly filtros As New GestorFiltros2()
...
#Region "Eventos de UI (Botones, Combos, etc.)"
    ...
    Private Sub BtnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        Dim nuevaRegla As ReglaFiltro2

        If selCount > 1 Then
            Dim valores = lstValores.SelectedItems.Cast(Of Object)().Select(Function(v) v.ToString()).ToArray()
            nuevaRegla = New ReglaFiltro2 With {.Columna = col, .Operador = OperadorComparacion2.EnLista, .Valor1 = String.Join("|", valores)}
        Else
            Dim v As String = lstValores.SelectedItem.ToString()
            nuevaRegla = New ReglaFiltro2 With {.Columna = col, .Operador = OperadorComparacion2.Igual, .Valor1 = v}
        End If
...
#Region "Chips UI"
    Private Sub CrearChip(regla As ReglaFiltro2)
        Dim descripcionValores As String = If(regla.Operador = OperadorComparacion2.EnLista, regla.Valor1.Replace("|", ", "), regla.Valor1)
    ...
    Private Sub ChipCerrar_Click(sender As Object, e As EventArgs)
        ...
        Dim reglaParaQuitar = CType(btn.Tag, ReglaFiltro2)
...
#Region "Utilidades y Acciones de Botones"
    ...
    Private Sub btnCopiarCorreos_Click(sender As Object, e As EventArgs) Handles btnCopiarCorreos.Click
        ...
        Dim correos = dvDatos.ToTable().AsEnumerable().Select(Function(r) r.Field(Of String)("Correo")).Where(Function(c) Not String.IsNullOrWhiteSpace(c)).Distinct(StringComparer.InvariantCultureIgnoreCase).ToArray()
